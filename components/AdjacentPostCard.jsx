...
const AdjacentPostCard = ({ post, position }) => (
  <>
    <div className="absolute rounded-md bg-center bg-no-repeat bg-cover shadow-lg inline-block w-full h-72" style={{ backgroundImage: `url('${post.featuredImage.url}')` }} />
    <div className="absolute rounded-md bg-center bg-gradient-to-b opacity-50 from-gray-400 via-gray-700 to-black w-full h-72" />
